...
export const secThreeSlideData = [
  ...
  export const secEightSlideData = [
    {
      href: "/",
      srcImg: "/images/defaultImg.png",
  ...
  export const pricingData = [
    {
      href: "/",
      srcImg: pricingImg,
      alt: "Commercial Insights",
      headingSix: "Commercial Insights",
      label: `Blogs - Dec 06 2021`,
      desc:[
        {
          text:"Hyper-targeted, just in time competitive intelligence to close your deal"
        },
        {
          text:"Competitor intelligence to uncover financial, ESG, and strategy differentiators"
        },
        {
          text:"Hyper-targeted, just in time competitive intelligence to close your deal"
        },
